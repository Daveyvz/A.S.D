...
public class MainScreen extends BorderPane {
	...
	public static Pane inter = new Pane();
	...
	public MainScreen() {
		...
		//webview alvast gezet voor spacing
		...
		inter.getChildren().addAll(ivGrid, ivRobot);
		inter.getChildren().addAll(ObOnArray);
		inter.getChildren().addAll(ObBetweenArray);
